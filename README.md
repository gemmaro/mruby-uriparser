...
For prior works, see [mruby-uri-parser](https://github.com/Asmod4n/mruby-uri-parser), which uses [Ada](https://ada-url.com/) (formerly [uri\_parser](https://github.com/Zewo/uri_parser)), and [mruby-uri](https://github.com/zzak/mruby-uri), which is written in pure Ruby.
